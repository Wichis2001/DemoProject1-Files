...
public class ProductosMasIngresosSucursal extends javax.swing.JFrame {
    ...
    ManejadorProductosMasIngresosSucursal manejador = new ManejadorProductosMasIngresosSucursal();
    Empleado empleado;
    AdminHomePage admin;
    private int local = 0;
    /**
    ...
    private void initComponents() {
        ...
        subtitulo2.setText("TOP 5 PRODUCTOS MAS INGRESOS SUCURSAL");
        getContentPane().add(subtitulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 220, -1, -1));
