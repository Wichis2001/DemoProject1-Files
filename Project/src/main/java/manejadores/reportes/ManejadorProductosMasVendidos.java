...
/**
 * Esta clase me permite manejar la ventana que contiene el reporte de los productos más vendidos de una empresa
 * @author luiss
 */
public class ManejadorProductosMasVendidos {
     ...
     * @param ventana
     */
    public void llenarTabla(ProductosMasVendidos ventana){
    ...
    public void setModelo(JTable tabla){
        ...
        String[] columna= {"Electrodomestico","Cantidades Vendidas"};
    ...
    public void setDatos(JTable tabla){
        ...
        listadoReportes = reportesDao.topProductosMasVendidos();
