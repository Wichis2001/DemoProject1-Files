...
/**
 * Está clase me permite manejar la ventana que incluye los productos más ingresados en una sucursal
 * @author luis
 */
public class ManejadorProductosMasIngresosSucursal {
     ...
     * @param ventana
     */
    public void llenarTabla(ProductosMasIngresosSucursal ventana, JComboBox seleccion){
    ...
    public void setModelo(JTable tabla){
        ...
        String[] columna= {"Nombre Producto", "Ingreso Generado."};
    ...
    public void setDatos(JTable tabla, JComboBox elementos){
        ...
        listadoReportes = reportesDao.productosMasIngresosSucursal(elementos);
