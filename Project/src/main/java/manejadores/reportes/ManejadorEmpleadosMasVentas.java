...
/**
 * Esta clase me permite manejarla ventana que muestra el reporte de los empleados con más ventas
 * @author luiss
 */
public class ManejadorEmpleadosMasVentas {
     ...
     * @param ventana
     */
    public void llenarTabla(EmpleadosMasVentas ventana){
    ...
    public void setModelo(JTable tabla){
        ...
        String[] columna= {"Nombre Empleado", "Ventas Realizadas"};
