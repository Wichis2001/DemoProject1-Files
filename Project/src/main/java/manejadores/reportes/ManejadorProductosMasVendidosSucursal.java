...
/**
 * Esta clase me permite poder manipular la ventana que inclulye el reporte de los productos más vendidos por sucursal
 * @author luis
 */
public class ManejadorProductosMasVendidosSucursal {
    ...
    public void setModelo(JTable tabla){
        ...
        String[] columna= {"Nombre Producto", "Cantidad de Ventas"};
     ...
     * @param tabla
     */
    public void setDatos(JTable tabla, JComboBox elementos){
        ...
        listadoReportes = reportesDao.prodcutosMasVendidosSucursal(elementos);
        ...
        for(int x=0; x<listadoReportes.size();x++){
            ...
            datos[1]= listadoReportes.get(x).getValorNumerico2();
            //Asignamos las filas
            modelo.addRow(datos);
        }
