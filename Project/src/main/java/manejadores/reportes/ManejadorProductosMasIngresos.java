...
/**
 * Esta clase me permite manejar la ventana que incluye el reporte de los productos que tienen más ingresos
 * @author luis
 */
public class ManejadorProductosMasIngresos {
     ...
     * @param ventana
     */
    public void llenarTabla(ProductosMasIngresos ventana){
    ...
    public void setModelo(JTable tabla){
        ...
        String[] columna= {"Nombre Producto", "Cantidad de Ingresos"};
    ...
    public void setDatos(JTable tabla){
        ...
        listadoReportes = reportesDao.productosMasIngresos();
