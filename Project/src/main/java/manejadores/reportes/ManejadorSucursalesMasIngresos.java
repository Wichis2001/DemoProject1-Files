...
/**
 * Está clase me permite manejar la ventana de la sucursal con más ingresos
 * @author luiss
 */
public class ManejadorSucursalesMasIngresos {
     ...
     * @param ventana
     */
    public void llenarTabla(SucursalesMasIngresos ventana){
    ...
    public void setModelo(JTable tabla){
        ...
        String[] columna= {"Nombre Sucursal", "Cantidad de Ganancia"};
    ...
    public void setDatos(JTable tabla){
        ...
        listadoReportes = reportesDao.sucursalesMasIngresos();
