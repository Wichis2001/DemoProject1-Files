...
/**
 * Esta clase me permite manejar la ventana del reporte de empleados con más ingresos
 * @author luiss
 */
public class ManejadadorEmpleadosMasIngresos {
     ...
     * @param ventana
     */
    public void llenarTabla(EmpleadosMasIngresos ventana){
    ...
    public void setModelo(JTable tabla){
        ...
        String[] columna= {"Nombre Empleado", "Ganancia Generada"};
